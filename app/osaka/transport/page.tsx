...
const cards: CityCard[] = [
  // ── 通訊 ─────────────────────────────────────────────────
  {
    ...
    actions: [
      { label: 'KarDear eSIM', href: 'https://kardear.com/product-category/kardear/network/esim/japan/?ref=390', className: 'btn primary recommend', event: 'osakatransport_esim_kardear', platform: 'KarDear', section: 'comm_card' },
  ...
  },
  {
    ...
    actions: [
      { label: 'KarDear SIM', href: 'https://kardear.com/product/sim-japan/?ref=390', className: 'btn primary recommend', event: 'osakatransport_simhome_kardear', platform: 'KarDear', section: 'comm_card' },
      { label: 'KKDAY', href: 'https://www.kkday.com/zh-tw/product/126982?cid=22312', className: 'btn', event: 'osakatransport_simhome_kkday', platform: 'KKDAY', section: 'comm_card' },
  ...
  },
  {
    ...
    actions: [
      { label: '合作租車', href: 'https://www2.tocoo.jp/cn/?asp_id=2564&utm_source=2564&utm_medium=affiliate', className: 'btn primary recommend', event: 'osakatransport_carrental_tocoo', platform: 'TOCOO', section: 'transport_card', promoCode: 'K24ZW3' },
