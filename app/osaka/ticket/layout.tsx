...
export const metadata: Metadata = {
  title: 'JieJourneys(旅杰)-日本大阪自由行票券攻略',
  description:
    'JieJourneys(旅杰)日本大阪自由行-一頁整理精選旅遊票券，包含教學短片、行程建議與購票連結，幫你在最短時間內選好票券。',
  openGraph: {
    type: 'website',
    locale: 'zh_TW',
    ...
    title: 'JieJourneys(旅杰)-日本大阪自由行票券攻略',
    description:
      'JieJourneys(旅杰)-一頁整理精選旅遊票券，包含教學短片、行程建議與購票連結，幫你在最短時間內選好票券。',
