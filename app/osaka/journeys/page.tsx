...
const jsonLd = {
  ...
  '@type': 'Product',
  name: '大阪市五日行程 PDF',
  description: '大阪五日自由行完整行程 PDF，含熱門景點最佳動線、美食清單、一鍵導航連結，永久使用。',
...
export default function OsakaJourneysPage() {
  return (
    <>
      <script
      ...
      />
      <JourneysHeader backHref="/osaka" eventPrefix="osakaPDF" />
        ...
        <section className="buy-box" aria-label="購買區塊">
          ...
          <div>
            <div className="form" style={{ marginTop: 12, textAlign: 'center' }}>
              <a href="/osaka/journeys/order.html" className="btn buy-now big-btn" data-event="osakaPDF_clickbuy" data-item="cta">
                立即取得PDF
              </a>
              <div className="cta-secondary">
                <a className="secondary-btn" href="https://www.instagram.com/reel/DOQv5njkT4I/" target="_blank" rel="noopener noreferrer" data-event="osakaPDF_TrialIG">
                  🎬 30秒看怎麼用
                </a>
              </div>
            </div>
        ...
        <section className="section">
          ...
          <div className="features">
            <article className="feature">
              <Image className="thumb" src="/osaka/journeys/assets/checklist.png" alt="行前準備清單" width={320} height={180} />
              <div className="title"><span className="icon">🧰</span> 行前準備</div>
              <p>一次處理入境、住宿、票券、換匯、地圖、交通。</p>
            </article>

            <article className="feature">
              <Image className="thumb" src="/osaka/journeys/assets/gonglue.png" alt="互動檔案與資訊" width={320} height={180} />
              <div className="title"><span className="icon">🗺️</span> 互動檔案</div>
              <p>最佳動線、地圖連結、圖影導覽、美食推薦、營業時間。</p>
            </article>

            <article className="feature">
              <Image className="thumb" src="/osaka/journeys/assets/jingdian.png" alt="景點精選照片" width={320} height={180} />
              <div className="title"><span className="icon">📌</span> 景點精選</div>
              <p>淺草寺、晴空塔、皇居、上野恩賜公園、阿美橫丁、新宿、原宿、涉谷。</p>
            </article>

            <article className="feature">
              <Image className="thumb" src="/osaka/journeys/assets/meishi.png" alt="美食清單照片" width={320} height={180} />
              <div className="title"><span className="icon">🍽️</span> 美食清單</div>
              <p>拉麵、壽喜燒、烤肉、壽司、日式丼飯、天婦羅、牛排。</p>
            </article>

            <article className="feature">
              <Image className="thumb" src="/osaka/journeys/assets/fengjing.png" alt="體驗活動圖像" width={320} height={180} />
              <div className="title"><span className="icon">✨</span> 特色體驗</div>
              <p>登高看夜景、走訪神社、逛商店街、體驗歷史、安排購物路線。</p>
            </article>

            <article className="feature">
              <Image className="thumb" src="/osaka/journeys/assets/gouwu.JPG" alt="購物地點圖像" width={320} height={180} />
      ...
      <div className="buy-bar show" role="region" aria-label="快速購買工具列">
        <div>
          <strong>大阪市五日行程</strong>
          <div className="secure">🔒 即時寄送 PDF</div>
        </div>
        <div className="price">NT$399</div>
        <a href="/osaka/journeys/order.html" className="btn buy-now" data-event="osakaPDF_clickbuy1" data-item="cta">
          立即取得PDF
        </a>
      </div>
