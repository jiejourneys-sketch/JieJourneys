...
const title = '大阪・京都・奈良旅杰地圖｜免費互動地圖・住宿票券景點・Google一鍵導航'
const description =
  '大阪・京都・奈良旅杰地圖整合大阪市區、京都、奈良、天橋立、伊根與美山等景點，並把票券景點、免費景點與住宿推薦放在同一張免費互動地圖。可切換票券、景點、住宿分類，查看購票連結並一鍵開啟 Google Map 導航。'
