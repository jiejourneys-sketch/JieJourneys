...
const cards = [
  ...
  { title: '沙壩3種交通方式', meta: '沙壩攻略', area: '沙壩攻略', datasetKey: 'video' as const, datasetValue: 'Sapa-Transport', actions: [{ label: 'IG Reels', href: 'https://www.instagram.com/reel/DSfHYvuEVEW/', className: 'btn primary', event: 'northvietnamvideo_SapatransportIG', platform: 'IG', section: 'video' }, { label: 'YouTube', href: 'https://www.youtube.com/shorts/jvAutp4FnZY', className: 'btn', event: 'northvietnamvideo_SapatransportYT', platform: 'YouTube', section: 'video' }, { label: '小紅書', href: 'https://xhslink.com/o/1HgJc0fxIOA', className: 'btn', event: 'northvietnamvideo_SapatransportXHS', platform: '小紅書', section: 'video' }, { label: '文章', href: '/northvietnam/hanoi-to-sapa-transport?from=video', className: 'btn', event: 'northvietnamvideo_SapatransportArticle', platform: 'article', section: 'video' }] },
