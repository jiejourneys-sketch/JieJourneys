...
const cards = [
  ...
  { title: '河內 ⇄ 沙壩｜包車', meta: '沙壩交通', area: '沙壩交通', datasetKey: 'title' as const, datasetValue: '河內 ⇄ 沙壩｜包車', actions: [{ label: 'KKDAY', href: 'https://www.kkday.com/zh-tw/product/27770-ha-noi-sapa-round-trip-transfer-by-sleeper-bus?cid=22312', className: 'btn primary', event: 'northvietnamtransport_sapa_car_kkday', platform: 'KKDAY', section: 'transport_card' }, { label: 'KLOOK', href: 'https://www.klook.com/zh-TW/activity/6363-private-city-transfer-hanoi-other-areas/?aid=93798', className: 'btn', event: 'northvietnamtransport_sapa_car_klook', platform: 'KLOOK', section: 'transport_card' }] },
