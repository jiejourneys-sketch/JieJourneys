...
const cards: CityCard[] = [
  ...
  },
  {
    ...
    actions: [
      { label: '合作租車', href: 'https://www2.tocoo.jp/cn/?asp_id=2564&utm_source=2564&utm_medium=affiliate', className: 'btn primary recommend', event: 'fujitransport_self_tocoo', platform: 'TOCOO', section: 'transport_card', promoCode: 'K24ZW3' },
