...
export default function FujiPlannerPage() {
  return <BusanPassPlannerClient mapCenter={FUJI_MAP_CENTER} places={fujiMapPlaces} config={fujiPlannerConfig} />
}
