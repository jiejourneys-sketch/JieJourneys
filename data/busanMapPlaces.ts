...
const BUSAN_SPOT_GEO: Record<string, { lat: number; lng: number }> = {
  樂天世界: { lat: 35.189058, lng: 129.202301 },
  '斜坡滑車SkyLine Luge': { lat: 35.196389, lng: 129.231884 },
  '釜山 X the Sky 展望台': { lat: 35.158202, lng: 129.160744 },
  '汗蒸幕｜新世界SPA LAND': { lat: 35.169033, lng: 129.131684 },
  松島海上纜車: { lat: 35.075698, lng: 129.017012 },
  '韓服體驗｜釜山甘川文化村': { lat: 35.142676, lng: 129.011529 },
  釜山塔: { lat: 35.101291, lng: 129.032492 },
  '膠囊列車&海岸列車': { lat: 35.163904, lng: 129.174971 },
  'Diamond Bay Yacht｜鑽石灣遊艇': { lat: 35.15395, lng: 129.130842 },
  'Yacht Holic｜水營灣遊艇': { lat: 35.15278, lng: 129.119145 },
  'Yacht G｜水營灣遊艇': { lat: 35.152945, lng: 129.11941 },
  'GoGo Yacht｜水營灣遊艇': { lat: 35.15311, lng: 129.11918 },
  'Yachtwa｜水營灣遊艇': { lat: 35.153265, lng: 129.118955 },
  'The Yacht｜水營灣遊艇': { lat: 35.15262, lng: 129.11962 },
  'Y Holic｜水營灣遊艇': { lat: 35.15245, lng: 129.11889 },
  'Yacht Tale｜水營灣遊艇': { lat: 35.15352, lng: 129.12978 },
  'SEA LIFE 釜山水族館門票': { lat: 35.161245, lng: 129.161488 },
  太宗台海洋飛行主題樂園: { lat: 35.057891, lng: 129.084612 },
}
